...
import '../Screens/Student Therapist/Screens/appointment_screen.dart';
import '../Screens/Student Therapist/Screens/chat_screen.dart';
import '../Screens/Student Therapist/Screens/profile.dart';

class STTNavbar extends StatelessWidget {
  const STTNavbar({super.key});
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => VaniAI()),
              );
            },
          ),
          ListTile(
