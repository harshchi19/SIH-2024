...
import { GET_ALL_ADM_ROUTE } from "@/utils/constants";
...
const AdminPage = () => {
  ...
  useEffect(() => {
    const getAllAdmins = async () => {
      try {
        const response = await fetch(GET_ALL_ADM_ROUTE, { method: "GET" });
  ...
  return (
    <div className="px-8">
      <div className="flex justify-between items-center mb-6 bg-white p-4 rounded-lg shadow-sm">
        <div>
          <h1 className="text-2xl font-bold">Admins Overview</h1>
